...
class CornerstoneElement extends React.Component {
  constructor(props){
    console.log("CornerstoneElement Constructor Started...");
    console.log(props);
    super(props);
  ...
  onMouseClick(event){
    const { detail } = event;
    const { image, currentPoints } = detail;
    const imageCoords = currentPoints.image;

    console.log('Clicked at image coordinates:', imageCoords);
    console.log('Clicked at image:', image);
  }
  ...
  componentDidMount() {
    ...
    cornerstone.loadImage(this.state.imageId).then(image => {
      ...
      element.addEventListener("cornerstonetoolsmouseclick", this.onMouseClick);
  ...
  componentWillUnmount() {
    ...
    element.removeEventListener("cornerstonetoolsmouseclick", this.onMouseClick);
